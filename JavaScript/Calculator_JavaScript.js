...
const Calculator = {
    ...
    Display_Value: '0',
    //this will hold the first operand for any expresstions, we set it to null for now
    First_Operand: null,
    //this checks whether or not the second operand has been input
    Wait_Second_Operand: false,
    //this will hold the operaotr, we set it to null for now
    operator: null,
};
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand ==null) {
        ...
        let result = Perform_Calculaltion[operator] (Value_Now, Value_of_Input);
